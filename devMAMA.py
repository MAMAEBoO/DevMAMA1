...
def startgrab():
    ...
    if peak == '':
        ...
        if peak == '1':
            os.system('clear')
            print logo
            print '[ # ] \x1b[37;1mlost\x1b[0m_+_\x1b[31;1m\x1b[0m'
            ...
            print '[ # ] \x1b[37;1mLost\x1b[0m_+_\x1b[31;1mSoftware\x1b[0m'
            try:
